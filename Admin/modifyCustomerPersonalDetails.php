...
if (isset($_GET['phone_number'])) {
    ...
    if ($result_set) {
        if (mysqli_num_rows($result_set) == 1) {
            ...
            header('Location: existCustomerAppointment.php?user_not_found');
        }
    }else {
        header('Location: existCustomerAppointment.php?query_failed');
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="CSS/existCustomerAppointmentStyle1.css">
</head>
