...
<head>
    ...
    <link rel="stylesheet" href="CSS/appointmentstyle3.css">
</head>
<body>
<main class="container">
    <div class="sub-section">
        ...
        <button type="button" id="addNew" name="submit" onclick="window.open('add_appointment.php','_top');">
            <span>Add New</span>
        </button>
                    ...
                    if ($customerMembers) {
                        while($customer = mysqli_fetch_assoc($customerMembers))
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Add Appointment -->
                                    <button type="button" id='addNew4' name="submit" onclick="window.open('existCustomerAppointment.php?user_id=<?php echo $customer['appointment_id'];?>','_top');">                                     
