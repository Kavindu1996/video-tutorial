...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO appointment (appointment_date, service, staff_id, role, amount, phone_number, employee_id, is_deleted) VALUES ('{$appointment_date}', '{$service}', '{$staff_id}', '{$role}', '{$amount}', '{$phone_number}', '{$employee_id}', 0 )";
        $result = mysqli_query($connection, $query);
...
<head>
    ...
    <link rel="stylesheet" href="CSS/add_appointment_Style2.css">
</head>
<body>
    <div class="container">
        <div class="title">
        ...
        <form action="add_appointment.php" method="post" class="userform">
